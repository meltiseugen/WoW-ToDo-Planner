...
local COILED_ISLE_RARE_WAYPOINTS = {
    "/way #2512 53.8 72.0 Farthik the Plunderer / interact with Unguarded Chest",
    "/way #2512 24.8 73.5 Kari'zah the Forgotten",
    "/way #2512 43.9 50.8 Hisstara",
    "/way #2512 69.5 45.0 Garsecg",
    "/way #2512 55.8 67.9 Coin-Eye Skully / patrols in water",
    "/way #2512 60.0 40.0 Sss'alik / patrols nearby path",
    "/way #2512 50.1 69.0 Siltmouth",
    "/way #2512 31.7 56.7 Lockjaw",
    "/way #2509 47.1 6.4 The Underbelly / Szarith entrance",
    "/way #2509 38.8 13.4 Szarith the Fanged",
    "/way #2512 52.4 43.1 Tomb of the Lost Priest entrance",
    "/way #2512 63.1 62.1 Nar'zira / inside Tomb of the Lost Priest",
    "/way #2512 70.1 63.5 Big Mon",
    "/way #2512 52.0 32.3 Destra",
}

local RALKALA_WAYPOINTS = {
    "/way #2512 58.2 48.5 Image of Astalor Bloodsworn / Curse of the Isle",
...
PatchCatalog.achievementDetails = {
    ...
    ["12.1"] = {
        [62492] = { sourceType = "Achievement", source = "The Coiled Isle Safari", acquisition = "Capture every wild pet listed for The Coiled Isle. The pet guide notes the Safari does not include every rare pet from the patch.", waypoints = { "/way #2512 67.8 81.4 Autumn Snapling", "/way #2509 39.0 28.2 Caustic Writhling", "/way #2512 47.2 59.8 Cursed Spawn", "/way #2512 45.2 31.2 Jaundiced Slitherer", "/way #2512 62.6 84.0 Nightfur Kapara", "/way #2512 62.2 40.8 Poisoned Parasite", "/way #2512 65.81 45.75 Sleek Snakebiter", "/way #2512 65.8 32.8 Steady Croakfrog" } },
        [63167] = { sourceType = "PvP", source = "Tour of Duty: The Coiled Isle", acquisition = "Kill enemy players on The Coiled Isle for the Tour of Duty achievement. War Mode and active PvP objectives are the practical farm path.", waypoints = { "/way #2512 59.4 49.5 Tokka's Landing", "/way #2512 51.5 49.7 Tokka's Folly" } },
        ...
        [63609] = { sourceType = "Raid achievement", source = "No Egg Scramble", acquisition = "Complete No Egg Scramble in The Venomous Abyss as part of Glory of the Venomous Raider.", waypoints = THE_VENOMOUS_ABYSS_WAYPOINTS },
        [63630] = { sourceType = "Achievement", source = "Assault the Vault", acquisition = "Complete the Vaults of Atal'Utek achievement set in the underground Coiled Isle zone.", waypoints = { "/way #2512 43.3 44.2 Gate of the Serpent Eye Entrance", "/way #2512 45.4 65.9 Gate of the Eastern Fang Entrance", "/way #2512 31.8 64.9 Gate of the Western Fang Entrance", "/way #2509 51.2 62.6 Altar of Corrosion" } },
        [63633] = { sourceType = "Achievement", source = "A Stack of Snacks", acquisition = "Complete the Ki'clak Snack Attack world quest five times while feeding Ki'clak. The pet guide notes this unlocks after the storyline beginning with Ghosts of the Ring.", waypoints = { "/way #2512 57.4 49.0 Ghosts of the Ring storyline hub", "/way #2512 59.4 49.5 Tokka's Landing" } },
        [63653] = { sourceType = "Achievement", source = "Pro Poison Patroller", acquisition = "Complete 250 patrols within the Vaults of Atal'Utek.", waypoints = { "/way #2512 43.3 44.2 Gate of the Serpent Eye Entrance", "/way #2512 45.4 65.9 Gate of the Eastern Fang Entrance", "/way #2512 31.8 64.9 Gate of the Western Fang Entrance", "/way #2509 51.2 62.6 Altar of Corrosion" } },
    },
}
...
PatchCatalog.mountDetails = {
    ...
    ["12.1"] = {
        ...
        ["Caustic Venomfang"] = { category = "Vendor", sourceType = "Vendor", source = "Skull of Er'inye", acquisition = "Unlock Skull of Er'inye once by completing Vaults Of Atal'Utek: Certain Doom from Warleader Abdumati, then buy Caustic Venomfang for 10000 Corrosive Coin.", waypoints = SKULL_OF_ERINYE_WAYPOINTS },
        ["Sea-Dwelling Isle Serpent"] = { category = "Vendor", sourceType = "Vendor", source = "Second Mate Sluggs", acquisition = "Reach Bloodsworn Crew with Captain Tokka, then buy Sea-Dwelling Isle Serpent from Second Mate Sluggs with Coiled Filament.", waypoints = SECOND_MATE_SLUGGS_WAYPOINTS },
        ...
        ["Spirit of Tok'jara"] = { category = "Quest Rewards", sourceType = "Questline", source = "The Innocent Essence quest chain / Zul'jarra's Forces Renown 10", acquisition = "Reach Zul'jarra's Forces Renown 10, then complete Du'gal's time-gated six-quest chain from Ancestral Gems through The Innocent Essence inside the Vaults of Atal'Utek.", waypoints = { "/way #2509 50.43 63.65 Du'gal / Ancestral Gems" } },
        ...
        ["Venomous Coiler"] = { category = "Quest Rewards", sourceType = "Achievement", source = "Assault the Vault", acquisition = "Complete the Vaults of Atal'Utek achievement set.", waypoints = { "/way #2512 43.3 44.2 Gate of the Serpent Eye Entrance", "/way #2512 45.4 65.9 Gate of the Eastern Fang Entrance", "/way #2512 31.8 64.9 Gate of the Western Fang Entrance", "/way #2509 51.2 62.6 Altar of Corrosion" } },
